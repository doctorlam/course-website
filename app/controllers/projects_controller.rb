class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit({lesson_ids: []},:attachment_link, :id, :due, :lesson, :user_id, :name, :description, :project_id, rubrics_attributes: [:id, :description, :_destroy], deliverables_attributes: [:id, :description, :_destroy], related_attributes: [:description, :id, :_destroy])
    end
