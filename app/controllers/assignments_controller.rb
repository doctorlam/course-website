class AssignmentsController < ApplicationController
  ...
  private
    ...
    def assignment_params
      params.require(:assignment).permit(:document, :assignment_type, {lesson_ids: []}, {submission_ids: []}, :lesson, :score, :fake_score, :lesson_id, :submission, :submission_id, :name, :description, :deadline)
    end
    def check_user
